...
func resetPricingEndpointTestTables(t *testing.T) {
	...
	require.NoError(t, DB.AutoMigrate(&Channel{}, &Ability{}, &Model{}, &Vendor{}, &ChannelBalanceProtection{}))
	for _, table := range []string{"abilities", "channels", "models", "vendors", "channel_balance_protections"} {
