...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		logRoute.POST("/:id/cancel", middleware.AdminAuth(), controller.CancelInFlightLog)
		...
		dataRoute.GET("/token_trend", middleware.UserAuth(), controller.GetTokenTrend)
		dataRoute.GET("/token_trend/models", middleware.UserAuth(), controller.GetTokenTrendModels)
